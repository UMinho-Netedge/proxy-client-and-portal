        ...
        <div className='page'>
          ...
          <div className='cofinanced'>
            ...
            <a href='https://www.compete2020.gov.pt/'>
              <img
                className='compete2020'
                src={require('./images/level_compete.png')}
                alt='compete2020'
              />
            </a>
            <a href='https://portaldosincentivos.pt/index.php/portugal-2020'>
              <img
                className='portugal2020'
                src={require('./images/level_portugal-2020.png')}
                alt='portugal2020'
              />
            </a>
            <a href='https://ec.europa.eu/regional_policy/funding/erdf_en?etrans=pt'>
              <img
                className='europa'
                src={require('./images/logos-FEDR_.png')}
                alt='europa'
              />
            </a>
          </div>
